...
/*
console.log(JSON.parse(clubs)[1].name);
console.log(JSON.parse(clubs)[1].contactInfo.contactPerson);
console.log(JSON.parse(clubs)[1].contactInfo.telephoneNumber);
 */
...
let Club = {
   ...
   "contactinformatie": {
      "Adres": "limousine",
      "Telefoonnummer": "ktm-duke",
      "Contactpersoon": "lufthansa"
   }
}
